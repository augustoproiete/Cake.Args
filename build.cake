...
Task("restore")
    ...
    .Does(() =>
{
    DotNetRestore("./Cake.Args.sln", new DotNetRestoreSettings
    {
        LockedMode = true,
    });
});
...
{
    DotNetBuild("./Cake.Args.sln", new DotNetBuildSettings
    {
...
Task("pack")
    ...
    .Does(() =>
{
    var releaseNotes = $"https://github.com/augustoproiete/Cake.Args/releases/tag/v{buildVersion.Version}";

    DotNetPack("./src/Cake.Args/Cake.Args.csproj", new DotNetPackSettings
    {
        Configuration = "Release",
        NoRestore = true,
        NoBuild = true,
